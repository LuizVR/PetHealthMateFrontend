<template>
  <ion-page>
    <ion-header>
      <ion-toolbar>
        <ion-title>Edita tu Mascota</ion-title>
      </ion-toolbar>
    </ion-header>
    <ion-content>
      <ion-item>
        <ion-label position="floating">Nombre</ion-label>
        <ion-input v-model="form.nombre" :value="form.nombre"></ion-input>
      </ion-item>
      <ion-item>
        <ion-label position="floating">Edad</ion-label>
        <ion-input v-model="form.edad" :value="form.edad"></ion-input>
      </ion-item>
      <ion-item>
        <ion-label position="floating">Peso</ion-label>
        <ion-input v-model="form.peso" :value="form.peso"></ion-input>
      </ion-item>
      <ion-item>
        <ion-label position="floating">Talla</ion-label>
        <ion-select v-model="form.talla" :value="form.talla"  placeholder="Selecciona una talla">
      ...
      <ion-item>
        ...
        <ion-select v-model="form.tipo" :value="form.tipo" placeholder="Selecciona una especie">
      ...
      <ion-item>
        ...
        <ion-select v-model="form.sexo" :value="form.sexo"  placeholder="Selecciona uno">
